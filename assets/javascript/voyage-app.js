...
function getWebcams(destName1, destName2) {
  ...
  let path =
    "nearby=" +
    coors + // coors = "latitude,longitude,radius"
    // "/category=beach +
  ...
  if (/destination.html/i.test(window.location.href)) {
    ...
    if (destination == "Bahamas") {
      ...
      let imgitem1 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://i2.wp.com/fishingbooker.com/blog/media/Fishing-in-the-Bahamas.jpg?resize=1024%2C683&ssl=1",
      });
      ...
      let imgitem2 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://www.fodors.com/wp-content/uploads/2018/03/Ultimate-Things-To-Do-Bahamas-Hero.jpg",
      });
      ...
      let imgitem3 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://q-cf.bstatic.com/images/hotel/max1024x768/147/147871201.jpg",
      });
    ...
    if (destination == "Vienna") {
      ...
      let imgitem5 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://images.wallpapersden.com/image/download/vienna-austria-capital_16962_2560x1440.jpg",
      });
      ...
      let imgitem6 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://s1.1zoom.me/b5050/912/Austria_Vienna_Fountains_Sculptures_Belvedere_565326_2560x1440.jpg",
      });
    ...
    if (destination == "San Diego") {
      ...
      let imgitem10 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://images.wallpaperscraft.com/image/san_diego_california_evening_pier_waves_sea_decline_8985_800x600.jpg",
      });
      ...
      let imgitem12 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://media.farandwide.com/81/c8/81c892124e9d421f8a7598d2a253c7c0.jpg",
      });
      ...
      let imgitem11 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://mustlovetraveling.com/wp-content/uploads/2019/06/old-town-san-diego.jpg",
      });
    ...
    if (destination == "Newport") {
      ...
      let imgitem18 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://assets.simpleviewinc.com/simpleview/image/upload/c_fill,h_759,q_60,w_1138/v1/clients/newportri/6e7b4a08_e50f_44e4_8e5a_a5de35cda481_ca154a01-fba4-411e-bc0d-371a6c97df35.jpg",
      });
      ...
      let imgitem19 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://whatsupnewp.com/wp-content/uploads/2015/10/bowens-wharf-newport-ri.jpg",
      });
    ...
    if (destination == "Alaska") {
      $("body").css(
        "background-image",
        "url('assets/Images/alaska_national_park.jpg')"
      );
      let carouselitem15 = $("<div>").attr("class", "carousel-item active");
      let imgitem15 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://www.steppestravel.com/app/uploads/2019/06/glacier-bay-alaska-800x600.jpg",
      });
      ...
      let imgitem16 = $("<img>").attr({
        class: "d-block w-100",
        src:
          "https://www.wallpapergeeks.com/wp-content/uploads/2013/12/Humpback-Whale-Alaska-Wallpaper-800x600.jpg",
      });
...
function displayMessages() {
  ...
  // build headers
  let $headerWrapper = $("<div>").attr(
    "class",
    "row text-white font-weight-bold text-center justify-content-center"
  );
  let $headerName = $("<div>").attr("class", "col-3 text-right").text("Name");
  let $headerEmail = $("<div>").attr("class", "col-4 text-left").text("Email");
  let $headerMsg = $("<div>")
    .attr("class", "col-5 h-auto text-left text-wrap")
    .text("Message");
  ...
  contactsRef.on(
    "child_added",
    function (snap) {
      let $msgWrapper = $("<div>").attr(
        "class",
        "row text-white text-center justify-content-center"
      );
      let $msgDivName = $("<div>")
        .attr("class", "col-3 text-right")
        .text(snap.val().n + " ");
      let $msgDivEmail = $("<div>")
        .attr("class", "col-4 text-left")
        .text(snap.val().e + " ");
      let $msgDivMsg = $("<div>")
        .attr("class", "col-5 h-auto text-left text-wrap")
        .html("<p class='text-break'>" + snap.val().m.toString() + "</p>");
...
function getMap(destination) {
  ...
  $.ajax({
    url: "https://maps.googleapis.com/maps/api/js?key=" + googleMapAPI + "&callback=initMap",
    method: "GET",
  }).then(function (response) {
